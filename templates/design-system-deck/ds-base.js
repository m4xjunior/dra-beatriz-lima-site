...
(() => {
  const base = '../..';
  for (const p of ["tokens/fonts.css","tokens/color.css","tokens/typography.css","tokens/scale.css","tokens/effect.css","tokens/semantic.css","tokens/components.css","styles.css"]) {
