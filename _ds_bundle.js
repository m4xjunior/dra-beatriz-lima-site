/* @ds-bundle: {"format":4,"namespace":"DraBeatrizLimaDesignSystem_3859fd","components":[],"sourceHashes":{"guidelines/doc-page.js":"371bab66f42d","motion/bl-motion.js":"2de5dcce0505"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.DraBeatrizLimaDesignSystem_3859fd = window.DraBeatrizLimaDesignSystem_3859fd || {});
...
(function (global) {
  ...
  var VER = "3.13.0";
  var BL_CDN = ["https://cdn.jsdelivr.net/npm/gsap@" + VER + "/dist/gsap.min.js", "https://cdn.jsdelivr.net/npm/gsap@" + VER + "/dist/ScrollTrigger.min.js", "https://cdn.jsdelivr.net/npm/gsap@" + VER + "/dist/SplitText.min.js"];
  ...
  function loadScript(src) {
    return new Promise(function (res, rej) {
      ...
      s.onload = res;
      s.onerror = function () {
        rej(new Error("BLMotion: falhou ao carregar " + src));
      };
  ...
  var D = {
    fast: function () {
      return dur("--duration-fast", "140ms");
    },
    base: function () {
      return dur("--duration-base", "260ms");
    },
    slow: function () {
      return dur("--duration-slow", "480ms");
    },
    slower: function () {
      return dur("--duration-slower", "800ms");
    }
  };
  ...
  function tilt(el, opts) {
    ...
    var rotX = g.quickTo(el, "rotationX", {
      duration: 0.5,
      ease: EASE.tilt
    });
    var rotY = g.quickTo(el, "rotationY", {
      duration: 0.5,
      ease: EASE.tilt
    });
    var scl = g.quickTo(el, "scale", {
      duration: 0.4,
      ease: EASE.tilt
    });
  ...
  function auto(root) {
    ...
    root.querySelectorAll("[data-bl-tilt]").forEach(function (el) {
      tilt(el);
    });
    root.querySelectorAll("[data-bl-split]").forEach(function (el) {
      split(el);
    });
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "motion/bl-motion.js", error: String((e && e.message) || e) }); }
